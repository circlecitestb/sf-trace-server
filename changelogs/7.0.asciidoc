...
- Use _doc as document type for Elasticsearch >= 7.0.0 https://github.com/snappyflow/beats/pull/9056[beats/9057].
- Automatically cap signed integers to 63bits https://github.com/snappyflow/beats/pull/8991[beats/8991].
- Build default distribution under the Elastic License. {pull}1645[1645].
- Log to journald under systemd by default rather than file. To revert this behaviour override BEAT_LOG_OPTS with an empty value https://github.com/snappyflow/beats/pull/8942[beats/8942] via {pull}1645[1645].
